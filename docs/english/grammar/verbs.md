...
[Link here](https://quankori.github.io/docs/english/grammar/tenses)

## Verb form

"Verbs form" có thể được hiểu như "dạng động từ". Có nhiều dạng động từ trong tiếng Anh để diễn tả các thời gian, chủ ngữ và mục đích khác nhau.

### Main verb

Main verb (động từ chính) là động từ trong câu được sử dụng để miêu tả hành động hoặc trạng thái của chủ ngữ. Main verb đóng vai trò quan trọng trong việc xác định thời gian, thể và diễn đạt ý nghĩa của câu.
